<template>
  <div class="rectangle-lesson">
    <div class="lesson-content">
      ...
      <section class="content-section">
        <h2>📐 Медіана прямокутного трикутника</h2>
        <div class="median-explanation">
          <p><strong>Медіана прямокутного трикутника</strong>, проведена до гіпотенузи, дорівнює її половині.</p>
          <canvas ref="medianCanvas" width="350" height="250"></canvas>
          <div class="formula-box">
            <div class="formula">m = c/2</div>
            <p>де m — медіана до гіпотенузи, c — гіпотенуза</p>
          </div>
        </div>
      </section>
      ...
      <section class="content-section summary">
        ...
        <div class="summary-box">
          ...
          <ul>
            ...
            <li>🔸 Медіана до гіпотенузи дорівнює її половині</li>
          </ul>
        </div>
      </section>
    </div>
